...
import { LOGIN, LOGOUT, ADD_INSTAGRAM, POST_FRIEND, PUT_FRIEND, GET_FRIENDS, DELETE_FRIEND, GET_POSTS, DELETE_POST, CHANGE_PASSWORD, DELETE_INSTAGRAM } from '../actions/actionTypes';
import { login, logout, addInstagram, changePasswordSaga, deleteInstagram } from './AuthSagas';
...
export default function* rootSaga() {
    yield all([
        ...
        takeLatest(DELETE_INSTAGRAM, deleteInstagram),
